class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},
Mʏ Nᴀᴍᴇ Is <a href=https://t.me/{}>{}</a>, हम सब को फ्री मे मूवी देते है।😍</b>"""

    HELP_TXT = """<b>Hᴇʏ {}
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""

    ABOUT_TXT = """<b>🤖 ᴍʏ ɴᴀᴍᴇ : {}
 👨‍💻 ᴄʀᴇᴀᴛᴏʀ : <a href='tg://openmessage?user_id=1991522624'>🅰𝙨𝙝 𝙆𝙚𝙩𝙘𝙝𝙪𝙢</a>
 📚 ʟɪʙʀᴀʀʏ : ɴᴏ ɪᴅᴇᴀ
 📝 ʟᴀɴɢᴜᴀɢᴇ : ʜɪɴᴅɪ
 ♻️ ᴅᴀᴛᴀ ʙᴀsᴇ : ꜰʀᴇᴇ ᴡᴀʟᴀ
 📡 ʜᴏsᴛᴇᴅ ᴏɴ  : ᴘᴀᴛᴀ ɴᴀɪ
 🥶 ʙᴜɪʟᴅ sᴛᴀᴛᴜs : 5G"""
...
Dᴇᴠᴇʟᴏᴘᴇʀ:
- <a href="tg://openmessage?user_id=1991522624">🅰𝙨𝙝 𝙆𝙚𝙩𝙘𝙝𝙪𝙢</a></b>"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/The_Happy_Hour_Hindi)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
Nᴀᴍᴇ - {}"""
    ...
    ALRT_TXT = """ये मूवी आपके लिए नई है 😒 अगर आपको चाइए तो वापस नाम लिखो 🥲"""

    OLD_ALRT_TXT = """ये मैसेज बहुत पुराना हो गया है वापस नाम लिखो 😗"""

    CUDNT_FND = """लगता है गलत नाम लिखा है 😐 सही नाम चुने 👇"""
...
ᴇxᴀᴍᴘʟᴇ : Loki S01 or Loki S01E04 or Lucifer S03E24</b>"""

    I_CUD_NT = """हमे ऐसा कुछ नहीं मिला है 😶 गूगल पर स्पेलिग चैक करो 🙄"""

    MVE_NT_FND = """मेरे स्टोर में ऐसी कोई मूवी नई है 😔"""

    TOP_ALRT_MSG = """मोव की खोज चालू है 😊"""
...
• ᴜꜱᴇʀɴᴀᴍᴇ : <a href='tg://openmessage?user_id=1991522624'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>"""
...
🛠️ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: <code>v2.7.1 [ Sᴛᴀʙʟᴇ ]</code></b>"""
    ...
    LOGO = """Congratulations 🎉 Sandip, Your Application is Running Sussecs....✅"""
